...
<head>
    ...
    <title>Presonal Diary Login</title>
    ...
    <script type="text/javascript">
        function checkForm(){
            ...
            if(userName==null || userName==""){
                document.getElementById("error").innerHTML="username can't be null";
                return false;
            }
            if(password==null || password==""){
                document.getElementById("error").innerHTML="password can't be null";
                return false;
            }
            return true;
        }
...
<div class="container">
    <form name="myForm" class="form-signin" action="login" method="post" onsubmit="return checkForm()">
        <h2 class="form-signin-heading">MyDiary</h2>
        ...
        <label class="checkbox">
            <input id="remember" name="remember" type="checkbox" value="remember-me">Rember Me &nbsp;&nbsp;&nbsp;&nbsp; <font id="error" color="red">${error }</font>
        </label>
        <button class="btn btn-large btn-primary" type="submit">Login</button>
        &nbsp;&nbsp;&nbsp;&nbsp;
        <button class="btn btn-large btn-primary" type="button" >Reset</button>

        <p align="center" style="padding-top: 15px;">&copy; 2017 MyDiary</p>
    </form>
</div>
</body>
</html>
